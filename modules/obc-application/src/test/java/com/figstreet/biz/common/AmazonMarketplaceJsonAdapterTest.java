...
public class AmazonMarketplaceJsonAdapterTest {
    @Test
    public void readTest() throws IOException {
        ...
        AmazonMarketplaceJsonAdapter adapter = new AmazonMarketplaceJsonAdapter();
        AmazonMarketplace result = adapter.read(jsonReader);

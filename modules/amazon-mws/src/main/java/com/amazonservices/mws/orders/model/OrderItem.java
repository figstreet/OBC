 ...
 *             &lt;element name="ShippingDiscountTax" type="{https://mws.amazonservices.com/Orders/2013-09-01}Money" minOccurs="0"/&gt;
 *             &lt;element name="PromotionDiscount" type="{https://mws.amazonservices.com/Orders/2013-09-01}Money" minOccurs="0"/&gt;
 *             &lt;element name="PromotionDiscountTax" type="{https://mws.amazonservices.com/Orders/2013-09-01}Money" minOccurs="0"/&gt;
 ...
 *             &lt;element name="IsTransparency" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *          &lt;/sequence&gt;
 *       &lt;/restriction&gt;
 *    &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class OrderItem extends AbstractMwsObject {
    ...
    /**
     * Get the value of ShippingDiscountTax.
     *
     * @return The value of ShippingDiscountTax.
     */
    ...
    /**
     * Set the value of ShippingDiscountTax.
     *
    ...
    public boolean isSetShippingDiscountTax() {
        return shippingDiscountTax != null;
    }
    ...
    /**
     * Get the value of PromotionDiscountTax.
     *
     * @return The value of PromotionDiscountTax.
     */
    ...
    /**
     * Set the value of PromotionDiscountTax.
     *
    ...
    public boolean isSetPromotionDiscountTax() {
        return promotionDiscountTax != null;
    }
    ...
    public boolean isSerialNumberRequired() {
        return serialNumberRequired!=null && serialNumberRequired.booleanValue();
    }

    /**
     * Get the value of SerialNumberRequired.
     *
     * @return The value of SerialNumberRequired.
     */
    ...
    /**
     * Set the value of SerialNumberRequired.
     *
    ...
    public boolean isSetSerialNumberRequired() {
        return serialNumberRequired != null;
    }
     ...
     * @return This instance.
     */
    public OrderItem withSerialNumberRequired(Boolean serialNumberRequired) {
        this.serialNumberRequired = serialNumberRequired;
        return this;
    }
    ...
    public boolean isIsTransparency() {
        return isTransparency!=null && isTransparency.booleanValue();
    }

    /**
     * Get the value of IsTransparency.
     *
     * @return The value of IsTransparency.
     */
    ...
    /**
     * Set the value of IsTransparency.
     *
     ...
     * @return This instance.
     */
    public OrderItem withIsTransparency(Boolean isTransparency) {
        this.isTransparency = isTransparency;
        return this;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        shippingDiscountTax = r.read("ShippingDiscountTax", Money.class);
        promotionDiscount = r.read("PromotionDiscount", Money.class);
        promotionDiscountTax = r.read("PromotionDiscountTax", Money.class);
        ...
        serialNumberRequired = r.read("SerialNumberRequired", Boolean.class);
        isTransparency = r.read("IsTransparency", Boolean.class);
    }
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.write("ShippingDiscountTax", shippingDiscountTax);
        w.write("PromotionDiscount", promotionDiscount);
        w.write("PromotionDiscountTax", promotionDiscountTax);
        ...
        w.write("SerialNumberRequired", serialNumberRequired);
        w.write("IsTransparency", isTransparency);
    }

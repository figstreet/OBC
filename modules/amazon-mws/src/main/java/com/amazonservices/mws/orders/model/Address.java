 ...
 *             &lt;element name="isAddressSharingConfidential" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *          &lt;/sequence&gt;
 *       &lt;/restriction&gt;
 *    &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Address extends AbstractMwsObject {
    ...
    public boolean isIsAddressSharingConfidential() {
        return isAddressSharingConfidential!=null && isAddressSharingConfidential.booleanValue();
    }

    /**
     * Get the value of isAddressSharingConfidential.
     *
     * @return The value of isAddressSharingConfidential.
     */
    public Boolean getIsAddressSharingConfidential() {
        return isAddressSharingConfidential;
    }

    /**
     * Set the value of isAddressSharingConfidential.
     *
     ...
     */
    public boolean isSetIsAddressSharingConfidential() {
        return isAddressSharingConfidential != null;
    }
     ...
     * @return This instance.
     */
    public Address withIsAddressSharingConfidential(Boolean isAddressSharingConfidential) {
        this.isAddressSharingConfidential = isAddressSharingConfidential;
        return this;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        municipality = r.read("Municipality", String.class);
        postalCode = r.read("PostalCode", String.class);
        countryCode = r.read("CountryCode", String.class);
        phone = r.read("Phone", String.class);
        addressType = r.read("AddressType", String.class);
        isAddressSharingConfidential = r.read("isAddressSharingConfidential", Boolean.class);
    }
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.write("Municipality", municipality);
        w.write("PostalCode", postalCode);
        w.write("CountryCode", countryCode);
        w.write("Phone", phone);
        w.write("AddressType", addressType);
        w.write("isAddressSharingConfidential", isAddressSharingConfidential);
    }

 ...
 *             &lt;element name="EasyShipShipmentStatus" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 ...
 *             &lt;element name="IsGlobalExpressEnabled" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 ...
 *             &lt;element name="PromiseResponseDueDate" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/&gt;
 *             &lt;element name="IsEstimatedShipDateSet" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *             &lt;element name="TaxRegistrationDetails" type="{https://mws.amazonservices.com/Orders/2013-09-01}TaxRegistrationDetails" maxOccurs="unbounded"/&gt;
 *             &lt;element name="IsSoldByAB" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *             &lt;element name="BuyerIdentificationInformation" type="{https://mws.amazonservices.com/Orders/2013-09-01}BuyerIdentificationInformation" minOccurs="0"/&gt;
 *          &lt;/sequence&gt;
 *       &lt;/restriction&gt;
 *    &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Order extends AbstractMwsObject {
    ...
    /**
     * Get the value of EasyShipShipmentStatus.
     *
     * @return The value of EasyShipShipmentStatus.
     */
    ...
    /**
     * Set the value of EasyShipShipmentStatus.
     *
    ...
    public boolean isSetEasyShipShipmentStatus() {
        return easyShipShipmentStatus != null;
    }
    ...
    public boolean isIsGlobalExpressEnabled() {
        return isGlobalExpressEnabled!=null && isGlobalExpressEnabled.booleanValue();
    }

    /**
     * Get the value of IsGlobalExpressEnabled.
     *
     * @return The value of IsGlobalExpressEnabled.
     */
    ...
    /**
     * Set the value of IsGlobalExpressEnabled.
     *
    ...
    public boolean isSetIsGlobalExpressEnabled() {
        return isGlobalExpressEnabled != null;
    }
     ...
     * @return This instance.
     */
    public Order withIsGlobalExpressEnabled(Boolean isGlobalExpressEnabled) {
        this.isGlobalExpressEnabled = isGlobalExpressEnabled;
        return this;
    }
    ...
    /**
     * Get the value of PromiseResponseDueDate.
     *
     * @return The value of PromiseResponseDueDate.
     */
    ...
    /**
     * Set the value of PromiseResponseDueDate.
     *
     * @param promiseResponseDueDate
     *            The new value to set.
     */
    public void setPromiseResponseDueDate(XMLGregorianCalendar promiseResponseDueDate) {
    ...
    public boolean isSetPromiseResponseDueDate() {
        return promiseResponseDueDate != null;
    }
     ...
     * @return This instance.
     */
    public Order withPromiseResponseDueDate(XMLGregorianCalendar promiseResponseDueDate) {
        this.promiseResponseDueDate = promiseResponseDueDate;
        return this;
    }
    ...
    public boolean isIsEstimatedShipDateSet() {
        return isEstimatedShipDateSet!=null && isEstimatedShipDateSet.booleanValue();
    }

    /**
     * Get the value of IsEstimatedShipDateSet.
     *
     * @return The value of IsEstimatedShipDateSet.
     */
    ...
    /**
     * Set the value of IsEstimatedShipDateSet.
     *
    ...
    public boolean isSetIsEstimatedShipDateSet() {
        return isEstimatedShipDateSet != null;
    }
     ...
     * @return This instance.
     */
    public Order withIsEstimatedShipDateSet(Boolean isEstimatedShipDateSet) {
        this.isEstimatedShipDateSet = isEstimatedShipDateSet;
        return this;
    }

    /**
     * Get the value of TaxRegistrationDetails.
     *
     * @return The value of TaxRegistrationDetails.
     */
    public List<TaxRegistrationDetails> getTaxRegistrationDetails() {
        if (taxRegistrationDetails==null) {
            taxRegistrationDetails = new ArrayList<TaxRegistrationDetails>();
        }
        return taxRegistrationDetails;
    }

    /**
     * Set the value of TaxRegistrationDetails.
     *
    ...
    public boolean isSetTaxRegistrationDetails() {
        return taxRegistrationDetails != null && !taxRegistrationDetails.isEmpty();
    }
     ...
     * @return This instance.
     */
    public Order withTaxRegistrationDetails(TaxRegistrationDetails... values) {
        List<TaxRegistrationDetails> list = getTaxRegistrationDetails();
        for (TaxRegistrationDetails value : values) {
            list.add(value);
        }
        return this;
    }
    ...
    public boolean isIsSoldByAB() {
        return isSoldByAB!=null && isSoldByAB.booleanValue();
    }

    /**
     * Get the value of IsSoldByAB.
     *
     * @return The value of IsSoldByAB.
     */
     ...
     * @return This instance.
     */
    public Order withIsSoldByAB(Boolean isSoldByAB) {
        this.isSoldByAB = isSoldByAB;
        return this;
    }

    /**
     * Get the value of BuyerIdentificationInformation.
     *
     * @return The value of BuyerIdentificationInformation.
     */
    public BuyerIdentificationInformation getBuyerIdentificationInformation() {
        return buyerIdentificationInformation;
    }

    /**
     * Set the value of BuyerIdentificationInformation.
     *
    ...
    public boolean isSetBuyerIdentificationInformation() {
        return buyerIdentificationInformation != null;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        easyShipShipmentStatus = r.read("EasyShipShipmentStatus", String.class);
        ...
        isGlobalExpressEnabled = r.read("IsGlobalExpressEnabled", Boolean.class);
        ...
        promiseResponseDueDate = r.read("PromiseResponseDueDate", XMLGregorianCalendar.class);
        isEstimatedShipDateSet = r.read("IsEstimatedShipDateSet", Boolean.class);
        taxRegistrationDetails = r.readList("TaxRegistrationDetails", "member", TaxRegistrationDetails.class);
        isSoldByAB = r.read("IsSoldByAB", Boolean.class);
        buyerIdentificationInformation = r.read("BuyerIdentificationInformation", BuyerIdentificationInformation.class);
    }
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.write("EasyShipShipmentStatus", easyShipShipmentStatus);
        ...
        w.write("IsGlobalExpressEnabled", isGlobalExpressEnabled);
        ...
        w.write("PromiseResponseDueDate", promiseResponseDueDate);
        w.write("IsEstimatedShipDateSet", isEstimatedShipDateSet);
        w.writeList("TaxRegistrationDetails", "member", taxRegistrationDetails);
        w.write("IsSoldByAB", isSoldByAB);
        w.write("BuyerIdentificationInformation", buyerIdentificationInformation);
    }

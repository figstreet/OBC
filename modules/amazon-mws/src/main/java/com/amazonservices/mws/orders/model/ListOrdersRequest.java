 ...
 *             &lt;element name="EasyShipShipmentStatus" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/&gt;
 *          &lt;/sequence&gt;
 *       &lt;/restriction&gt;
 *    &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ListOrdersRequest extends AbstractMwsObject {
    ...
    public List<String> getEasyShipShipmentStatus() {
        if (easyShipShipmentStatus==null) {
            easyShipShipmentStatus = new ArrayList<String>();
        }
     ...
     *            The new value to set.
     */
    public void setEasyShipShipmentStatus(List<String> easyShipShipmentStatus) {
    ...
    public boolean isSetEasyShipShipmentStatus() {
        return easyShipShipmentStatus != null && !easyShipShipmentStatus.isEmpty();
    }
     ...
     * @return This instance.
     */
    public ListOrdersRequest withEasyShipShipmentStatus(String... values) {
        List<String> list = getEasyShipShipmentStatus();
        for (String value : values) {
            list.add(value);
        }
        return this;
    ...
    public void readFragmentFrom(MwsReader r) {
        ...
        easyShipShipmentStatus = r.readList("EasyShipShipmentStatus", "Status", String.class);
    }
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.writeList("EasyShipShipmentStatus", "Status", easyShipShipmentStatus);
    }

...
public class InventorySupplyDetail extends AbstractMwsObject {
    ...
    public void readFragmentFrom(MwsReader r) {
        this.quantity = r.read("Quantity", Integer.class);
        this.supplyType = r.read("SupplyType", String.class);
        this.earliestAvailableToPick = r.read("EarliestAvailableToPick", Timepoint.class);
        this.latestAvailableToPick = r.read("LatestAvailableToPick", Timepoint.class);
    }
    ...
    public void writeFragmentTo(MwsWriter w) {
        ...
        w.write("SupplyType", this.supplyType);
        w.write("EarliestAvailableToPick", this.earliestAvailableToPick);
        w.write("LatestAvailableToPick", this.latestAvailableToPick);
    }

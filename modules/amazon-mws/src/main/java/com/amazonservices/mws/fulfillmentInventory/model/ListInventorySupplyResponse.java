...
public class ListInventorySupplyResponse extends AbstractMwsObject implements MWSResponse {
    ...
    public ListInventorySupplyResult getListInventorySupplyResult() {
        return this.listInventorySupplyResult;
    }
    ...
    public void readFragmentFrom(MwsReader r) {
        this.listInventorySupplyResult = r.read("ListInventorySupplyResult", ListInventorySupplyResult.class);
    ...
    public void writeFragmentTo(MwsWriter w) {
        w.write("ListInventorySupplyResult", this.listInventorySupplyResult);

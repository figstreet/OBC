...
public class Timepoint extends AbstractMwsObject {
    ...
    public void readFragmentFrom(MwsReader r) {
        this.timepointType = r.read("TimepointType", String.class);
        this.dateTime = r.read("DateTime", XMLGregorianCalendar.class);
    }
    ...
    public void writeFragmentTo(MwsWriter w) {
        w.write("TimepointType", this.timepointType);
        w.write("DateTime", this.dateTime);
    }
